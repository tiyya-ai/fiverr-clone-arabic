...
// Real Professional Service Providers
export const mockUsers: User[] = [
  {
    id: '1',
    username: 'ahmed_electrical',
    ...
    isOnline: true,
    memberSince: '2019',
    bio: 'كهربائي معتمد مع خبرة 12 سنة في تركيب وصيانة الأنظمة الكهربائية السكنية والتجارية. حاصل على شهادات معتمدة من الهيئة السعودية للمهندسين.',
    skills: ['تركيب الكهرباء', 'صيانة اللوحات الكهربائية', 'تركيب الإنارة', 'أنظمة الطاقة الشمسية'],
  ...
  {
    id: '2',
    username: 'sara_plumber',
    fullName: 'سارة أحمد السباكة',
    ...
    isOnline: false,
    memberSince: '2020',
    bio: 'سباكة محترفة متخصصة في تركيب وصيانة أنظمة المياه والصرف الصحي. خبرة 8 سنوات في المشاريع السكنية والتجارية.',
    skills: ['تركيب المواسير', 'إصلاح التسريبات', 'تركيب الأدوات الصحية', 'صيانة الخزانات'],
    languages: ['العربية'],
    ...
    isVerified: true,
    verificationStatus: 'verified',
    verificationBadges: ['identity', 'skills', 'phone', 'email'],
    completedTasks: 654,
  ...
  },
  {
    ...
    isOnline: true,
    memberSince: '2017',
    bio: 'فني تكييف وتبريد معتمد من شركات عالمية. متخصص في تركيب وصيانة جميع أنواع أنظمة التكييف المركزي والمنفصل.',
    skills: ['تركيب التكييف المركزي', 'صيانة المكيفات', 'أنظمة التهوية', 'التبريد التجاري'],
    languages: ['العربية', 'الإنجليزية'],
  ...
  {
    id: '4',
    username: 'fatima_carpenter',
    fullName: 'فاطمة علي النجارة',
    ...
    isOnline: true,
    memberSince: '2021',
    bio: 'نجارة ماهرة متخصصة في صناعة الأثاث المخصص والديكورات الخشبية. أعمل بأحدث الأدوات والتقنيات لضمان جودة عالية.',
    skills: ['صناعة الأثاث', 'الديكورات الخشبية', 'إصلاح الأثاث', 'النجارة المعمارية'],
    languages: ['العربية'],
    ...
    isVerified: true,
    verificationStatus: 'verified',
    verificationBadges: ['identity', 'skills', 'phone'],
    completedTasks: 432,
    verificationScore: 91
  },
  {
    id: '5',
    username: 'hassan_painter',
    fullName: 'حسن محمود الدهان',
    ...
    isOnline: false,
    memberSince: '2018',
    bio: 'دهان محترف مع خبرة 10 سنوات في أعمال الدهان والديكور. متخصص في الدهانات الحديثة والتشطيبات الفاخرة.',
    skills: ['دهان الجدران', 'الديكورات الجبسية', 'ورق الجدران', 'الدهانات الخاصة'],
    languages: ['العربية'],
